                    ...
                    <div class="manual-entry-form">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-wrapper">
                                <input type="text" class="form-control" id="equipment-name-input" placeholder="Enter exact equipment name (e.g., 'Projector')">
                ...
                fetch(`validate-equipment.php?name=${encodeURIComponent(equipmentName)}`)
                    ...
                    .then(data => {
                        if (data.valid) {
                            ...
                            validEquipment = true;
                            showValidFeedback('Equipment name found in database');
                            ...
                            validEquipment = false;
                            showInvalidFeedback("Equipment not found in database. Make sure the name matches exactly.");

                                    ...
                                    <div class="step-content" id="step2">
                                        <div class="form-group">
                                            ...
                                            <div class="date-input-container">
                                                ...
                                                ?>
                                                <input type="date" id="reservationDate" name="reservationDate" class="form-control date-input" min="<?php echo $tomorrow; ?>" required>
                                            </div>
                                        </div>
        ...
        <div class="action-section text-center">
            ...
            <script>
                ...
                document.getElementById('toStep2').addEventListener('click', function(e) {
                    ...
                    if (!participantsInput.checkValidity() || isNaN(participantsCount) || participantsCount <= 0) {

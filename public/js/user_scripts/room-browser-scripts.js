            ...
            if (data.success) {
                ...
                if (data.equipment && data.equipment.length > 0) {
                    data.equipment.forEach(function(item) {
                        ...
                        let conditionClass = item.statusCondition ? 'condition-' + item.statusCondition : 'condition-unknown';
                        let conditionText = item.statusCondition ? item.statusCondition.replace('_', ' ') : 'Unknown';
                        equipmentList += `
                            <div class="equipment-item">
                                <span class="equipment-name">${item.name}</span>
                                <div>
                                    <span class="equipment-condition ${conditionClass}">Condition: ${conditionText}</span>
                                </div>
                            </div>
                        `;
                    });
    ...
    function disablePastDates() {
        ...
        $('#reservationDate').on('input change', function() {
            ...
            if (selectedDate < tomorrow) {
                // If a date before tomorrow is somehow selected, reset to tomorrow

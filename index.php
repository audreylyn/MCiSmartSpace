...
<body>
    ...
    <div class="login-form">
        <div class="form-container">
            ...
            <?php if (isset($_GET['error_type']) && $_GET['error_type'] === 'timeout'): ?>
                <div class="error-message">
                    Your session has timed out due to inactivity. Please login again.
                </div>
            <?php endif; ?>

            <?php if (isset($_GET['error_type']) && $_GET['error_type'] === 'security'): ?>
                <div class="error-message">
                    Your session has been terminated for security reasons. Please login again.
                </div>
            <?php endif; ?>

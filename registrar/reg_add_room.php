        ...
        <div class="all_container">
            ...
            <section class="section main-section">
                <div class="card">
                    ...
                    <div class="card-content">
                        <form method="POST" class="form" id="roomForm">
                            <div class="field is-grouped">
                                <div class="control">
                                    <label class="label">Room Name:</label>
                                    <div class="tooltip-container">
                                        <input class="input" type="text" name="room_name" id="room_name" required>
                                        <div class="tooltip-text" id="room_name_error">This room name already exists in the selected building.</div>
                                    </div>
                                </div>
                                <div class="control">
                                    <label class="label">Capacity:</label>
                                    <input class="input" type="number" name="capacity" min="1" max="50" required>
                                </div>
                            </div>

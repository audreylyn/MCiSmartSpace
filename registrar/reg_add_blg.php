...
<head>
    ...
    <link rel="stylesheet" href="../public/css/libs/materialdesignicons.min.css">
    ...
    <!-- DataTables CSS -->
    <link rel="stylesheet" href="../public/css/libs/jquery.dataTables.min.css">
                            ...
                            <div class="field is-inline">
                                <div class="control">
                                    ...
                                    <div class="tooltip-container">
                                        <input class="input" type="text" name="building_name" id="building_name" required>
                                        <div class="tooltip-text" id="building_name_error">This building name already exists.</div>
                                    </div>
                                </div>
                                <div class="control">
                                    <label class="label">Number Of Floors:</label>
                                    <input class="input" type="number" name="number_of_floors" min="1" max="6" required>
                                </div>
                            </div>

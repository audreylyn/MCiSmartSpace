...
<body>
    <div id="app">
                                    ...
                                    <table id="facilityTable" class="table is-fullwidth is-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                <tr>
                                                    <td colspan="7" class="has-text-centered">No facilities found.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                ...
                <section class="modal-card-body">
                    <form id="editForm" method="POST">
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input" type="number" name="capacity" id="edit_capacity" required min="1" max="50">
                            </div>
                        </div>
        ...
        <?php
        // Now it's safe to close the statement and connection
        if (isset($stmt)) {
            $stmt->close();
        }
        if (isset($conn)) {

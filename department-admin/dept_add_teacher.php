                            ...
                            <div class="field is-inline">
                                <div class="control">
                                    ...
                                    <div class="tooltip-container">
                                        <input class="input" type="email" name="email" id="teacher_email" required>
    ...
    <script>
        $(document).ready(function() {
                ...
                if (email.length > 0) {
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.exists) {
                                $('#teacher_email').addClass('input-error');
                                ...
                                $('#teacher_email').removeClass('input-error');
                                $('#email_error').removeClass('show-tooltip');
                            }
                        }
                    });
            ...
            $('form').on('submit', function(e) {
                var email = $('#teacher_email').val().trim();

                // First check if there's already an error shown
                if ($('#teacher_email').hasClass('input-error')) {
                    e.preventDefault();

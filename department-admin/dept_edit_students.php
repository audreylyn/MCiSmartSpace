...
<head>
    ...
    <style>
        ...
        /* Modal CSS from room-browser.css */
        .modal {
            z-index: 1050;
        }
        ...
        .modal-header {
            background: linear-gradient(to right, #f0f9ff, #fff1e6);
        ...
        /* Additional styles for more compact form layout */
        .form-group.compact {
            margin-bottom: 10px;
        }
        ...
        /* Ensure the modal is not too tall */
        .modal-dialog {
            max-height: 95vh;
            display: flex;

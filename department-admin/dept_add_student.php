...
<head>
    ...
    <style>
        ...
        label[for="studentTable_length"],
        label select[name="studentTable_length"] {
            display: none;
        }
        ...
        /* Show the tooltip when hovering or when has-tooltip class is added */
        .input-error:hover+.tooltip-text,
...
<body>
                ...
                <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="form-grid">
                    ...
                    <div class="form-row">
                        <div class="input">
                            <select name="department" id="department" required>
                                ...
                                <?php
                                $departments = ['Accountancy', 'Business Administration', 'Hospitality Management', 'Education, Arts, and Sciences', 'Criminal Justice Education'];
                    ...
                    <div class="form-row">
                        <div class="tooltip-container">
                            <input class="input" type="email" name="email" id="student_email" placeholder="Email" required>
                            <div class="tooltip-text" id="email_error">This email already exists. Please use a different email.</div>
                        </div>
                        <div class="tooltip-container">
                            <input class="input" type="password" name="password" placeholder="Password" minlength="8" required>
                            <div class="tooltip-text" id="password_error">Password must be at least 8 characters long.</div>
                        </div>
    ...
    <script type="text/javascript" src="../public/js/admin_scripts/add_student.js"></script>
    <!-- DataTables JS -->
